...
const CompanyChatIntializerScreen = (props: any) => {
  // Variables
  ...
  useEffect(() => {
    console.log('----->>>', profile._id, route.params.data.driver._id);
    dispatch(
      getChatByIds(
        profile._id,
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.searchView}>
        ...
        <View style={[styles.input2]}>
          {chat?.status == 'BLOCKED' &&
          chat?.blockedBy != profile._id ? null : (
            <Icon
              onPress={() => {
                setShowOption(true);
              }}
              ...
              onPress={() => {
                ...
                if (file?.uri == undefined) {
                  sockett.emit('driver-company-chat', {
                    driverId: route.params.data.driver._id,
                    companyId: profile._id,
                    sendBy: 'company',
                    message: message,
                    attachment: '',
          ...
          <View
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                {
                  dispatch(
                    chatBlockUnblock(chat?._id, profile._id, (success, msg) => {
                      if (success) {
...
export default CompanyChatIntializerScreen;
