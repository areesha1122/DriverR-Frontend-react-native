...
import {registerDriverr} from 'src/redux/auth/authApiCalls';
import {TextInput} from 'react-native-paper';
import {fontSizes} from 'src/config/fontSize';
import {getAccountType, getLanguage} from 'src/redux/auth/authSelector';
    ...
    <SafeAreaView
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          {/* <View>
            <Text language={language} style={styles.text2}> Confirm Password </Text>
            <InputFeild
              onChangeText={text => {
                setConfirmPassword(text);
                setConfirmPasswordError('');
