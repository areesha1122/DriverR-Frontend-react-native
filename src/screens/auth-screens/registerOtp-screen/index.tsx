...
import {resendDriverOtp, verifyOtpDriver} from 'src/redux/auth/authApiCalls';
import {useDispatch, useSelector} from 'react-redux';
import AwesomeAlert from 'react-native-awesome-alerts';
import Text from 'src/components/text';
import {getLanguage} from 'src/redux/auth/authSelector';

const RegisterOtpScreen = (props: any) => {
  // Variables
  ...
  return (
    <SafeAreaView
      ...
      <View style={styles.container}>
        ...
        <Text language={language} style={{marginLeft: 15 * widthRef}}>
        ...
        <View style={styles.bottomView}>
          <View
            ...
            <Text
              ...
              {showResend ? 'Resend OTP' : remainingTime}
            </Text>
          </View>
          <Button
            onPress={() => {
