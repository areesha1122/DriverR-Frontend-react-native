...
import CompanyInterviewScreen from 'src/screens/Company/interview-screen';
...
function TabNavigator(props: any) {
  ...
  return (
    <Tab.Navigator initialRouteName="CompanyHomeScreen">
      <Tab.Screen
      ...
      <Tab.Screen
        name="DummyScreen"
        component={CompanyInterviewScreen}
        options={{
          tabBarStyle: styles.lowerBar,
          tabBarLabel: '',
          headerTitle: '',
